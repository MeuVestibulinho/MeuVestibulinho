      ...
      <main className="container mx-auto flex-1 px-4 py-24 md:py-32">
        ...
        >
          ...
          <p className="mt-3 text-gray-600">
            Entenda, passo a passo, como usar nossos programas e recursos para
            se preparar com eficiência para o vestibulinho.
          </p>
        </motion.div>
        ...
        <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-6">
            <Section icon={BookOpen} title="Simulados personalizados">
              <p>
                Monte provas por matéria e dificuldade, com timer embutido. O
                sistema salva seu histórico para que você acompanhe evolução,
                acertos por tema e tempo médio por questão.
              </p>
              ...
              <a
                href="#"
                className="mt-3 inline-flex items-center gap-1 text-red-600 hover:underline"
              >
            ...
            <Section icon={Timer} title="Timer & gestão de tempo">
              <p>
                Treine na pressão certa: o cronômetro replica a dinâmica de
                prova. Você pode pausar entre blocos, visualizar tempo restante
                e comparar seu pacing por matéria.
              </p>
            </Section>

            <Section icon={Play} title="Mini cursos por tópico">
              <p>
                Aulas objetivas com teoria essencial + exercícios rápidos. Ideal
                para revisar pontos fracos identificados nas métricas e
                consolidar conteúdos de alta incidência.
              </p>
              <a
                href="#"
                className="mt-3 inline-flex items-center gap-1 text-red-600 hover:underline"
          ...
          <div className="space-y-6">
            <Section icon={GraduationCap} title="Guia de Estudos (Trilha)">
              <p>
                Um roteiro sugerido para organizar sua semana: teoria, questões,
                revisões e simulados. Adapte a trilha ao seu ritmo e foque nos
                temas com maior impacto.
              </p>
              <ul className="mt-3 list-disc pl-5 text-sm">
                ...
                <li>
                  Integração com métricas para priorizar o que mais importa.
                </li>
              </ul>
              <a
                href="/guia"
            ...
            <Section icon={Sparkles} title="Desafios diários (streak)">
              <p>
                Complete pelo menos um conjunto de exercícios por dia para
                manter sua sequência ativa e construir consistência. Pequenas
                vitórias diárias, grande resultado no fim.
              </p>
            </Section>

            <Section icon={Users} title="Comunidade & suporte">
              <p>
                Participe da comunidade para trocar dicas e tirar dúvidas. Conte
                também com a Central de Ajuda para tutoriais e respostas
                rápidas.
              </p>
          ...
          <div className="space-y-6">
            <Section icon={User} title="Meu Espaço (perfil e progresso)">
              <p>
                Seu hub pessoal: histórico de simulados, metas da semana,
                materiais salvos e recomendações personalizadas com base no seu
                desempenho.
              </p>
              <ul className="mt-3 list-disc pl-5 text-sm">
            ...
            <Section icon={BarChart3} title="Métricas & painel (dashboard)">
              <p>
                Acompanhe seus indicadores: acertos por matéria, tópicos com
                maior ganho marginal, tempo médio por questão e evolução
                semanal. Use esses dados para ajustar seu estudo.
              </p>
            </Section>

            <Section
              icon={CheckCircle2}
              title="Boas práticas para aproveitar tudo"
            >
              <ul className="list-disc pl-5 text-sm">
                ...
                <li>
                  Atualize sua trilha conforme as métricas apontarem
                  prioridades;
                </li>
                <li>
                  Faça um “mini simulado” no dia anterior à prova para calibrar
                  ritmo.
                </li>
              </ul>
            </Section>
            ...
            <Section icon={Shield} title="Privacidade & termos">
              <p>
                Tratamos dados para personalizar sua experiência, melhorar a
                plataforma e garantir segurança. Consulte os documentos
                oficiais:
              </p>
              <div className="mt-3 flex flex-wrap gap-3 text-sm">
                <a
